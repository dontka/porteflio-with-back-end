    ...
    <div class="login-wrapper">
        ...
        <div class="login-container">
            ...
            <div class="login-form-panel">
                ...
                <form method="POST" action="<?php echo $systemUrl; ?>login">
                ...
                <div class="login-footer">
                    <a href="<?php echo $systemUrl; ?>register"><i class="fas fa-user-plus"></i> Pas encore de compte ? S'inscrire</a>
                </div>
            </div>
        </div>
    </div>

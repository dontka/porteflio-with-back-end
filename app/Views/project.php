            ...
            <div class="col-lg-8">
                <div class="project-detail-card">
                    ...
                    <div class="project-detail-image">
                        <img class="img-fluid" src="<?php echo $systemUrl . sanitizeOutput($project['image_url']); ?>" alt="<?php echo sanitizeOutput($project['title']); ?>" loading="lazy" width="800" height="500" />
                    </div>
                    <?php endif; ?>
